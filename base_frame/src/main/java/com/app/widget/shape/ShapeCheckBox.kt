...
class ShapeCheckBox
    ...
    constructor(
        ...
        private fun init(
            ...
            bottomLeftRadius =
                ta.getDimensionPixelSize(R.styleable.ShapeCheckBox_bottomLeftRadius, radius)
            bottomRightRadius =
                ta.getDimensionPixelSize(R.styleable.ShapeCheckBox_bottomRightRadius, radius)
            // 选择器
            ...
            solidSelectColor =
                ta.getColor(R.styleable.ShapeCheckBox_solidSelectColor, Color.TRANSPARENT)
            strokeSelectColor =
                ta.getColor(R.styleable.ShapeCheckBox_strokeSelectColor, Color.TRANSPARENT)
            ta.recycle()
        }
    }
